...
// FIX: Import the `Question` type to use for explicit typing.
...
export const BUILDS: Build[] = [
    { id: 'story', name: 'Storybuild', description: 'Develop characters, plot, and themes for your narrative.', icon: <FilmIcon className="w-6 h-6" />, questions: storyQuestions },
    { id: 'shot', name: 'Shotbuild', description: 'Design the cinematography and visual language for a specific shot.', icon: <DocumentTextIcon className="w-6 h-6" />, questions: shotQuestions },
    { id: 'image', name: 'Imgbuild', description: 'Generate AI image prompts from your Shotbuild seeds.', icon: <PhotoIcon className="w-6 h-6" />, questions: imageQuestions },
    { id: 'video', name: 'Videobuild', description: 'Create a plan for a video sequence, including editing and audio.', icon: <VideoCameraIcon className="w-6 h-6" />, questions: videoQuestions },
    { id: 'edit', name: 'Edit Report', description: 'Get AI feedback on pacing, visuals, and audio for an edit.', icon: <ScissorsIcon className="w-6 h-6" />, questions: editQuestions },
];
